<div class="container-fluid bg-dark text-light p-3 d-flex justify-content-between align-items-center sticky-top">
    <h3 class="mb-0 h-font">OceanOasis HOTEL</h3>
    <a href="../scripts/logout.php" class="btn btn-light btn-sm">LOG OUT</a>
</div>

<div class="col-lg-2 bg-dark border-top border-secondry border-3" id="dashmenu-menu">
        ...
        <div class="container-fluid flex-lg-column align-items-stretch">
            ...
            <div class="collapse navbar-collapse flex-column mt-2 align-items-stretch" id="adminDropdown">
                <ul class="nav nav-pills flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="user_query.php">User_queries</a>
                    </li>
                    <li class="nav-item">
